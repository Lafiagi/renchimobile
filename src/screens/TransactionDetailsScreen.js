...
const TransactionDetailsScreen = ({numberOffersAvailable=3201, vendors, navigation}) =>{
  ...
  return(
        <ScrollView showsVerticalScrollIndicator={false} style={styles.scrollView} contentContainerStyle={styles.contentContainer}>
          ...
          <View>
          <Text style={{padding:15, color:'#CDCDCF'}}>
           Payment receipts
          </Text>
          <Card>
           <View  style={{flex: 1, flexDirection: 'row', justifyContent: 'space-between'}}>
                ...
                <Foundation name="page-pdf" size={24} color="black" />
                    ...
                    <Text style={{color: '#000', marginLeft: 6}}>Transaction-090090</Text>
                </View>
                
                <Text style={{textDecorationLine: 'underline', color: '#9B90C3'}}>
                    View
                </Text>
           </View>
       </Card>
